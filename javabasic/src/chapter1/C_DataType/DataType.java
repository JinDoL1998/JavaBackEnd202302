...
public class DataType {
	...
	public static void main(String[] args) {
		...
		// 정수 타입
		// byte type
		// 1byte (-128 ~ 127) 크기의 데이터를 가질 수 있는 데이터 타입
		byte byte1 = 127;
		// byte1 = 128;
...
//		int2 = float2;
		...
		// 강제 형 변환(명시적 형 변환)
		// 차지하는 범위가 큰 데이터 타입은 범위가 작은 데이터 타입으로  대입할때 형 변환을 명시해야 함
		// 강제 형변환의 경우 overflow (범위초과)가 발생할 수 있음
		short2 = (short)int2;
